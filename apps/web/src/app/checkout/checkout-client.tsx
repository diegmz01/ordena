...
export default function CheckoutClient() {
  ...
  async function payWithToken(
    ...
    if (result.clientSecret) {
      // El formulario de pago se muestra solo, en su propia página, para que
      // la atención se concentre ahí (nada de header/resumen alrededor).
      writePendingPayment(result.clientSecret, effectiveBranch);
      router.push("/checkout/pagar");
      return;
    }
